...
{
    [DbContext(typeof(abp_obs_projectDbContext))]
    [Migration("20251106174820_AddStudentTeacherCourseGradeAttendanceEntities")]
    partial class AddStudentTeacherCourseGradeAttendanceEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("abp_obs_project.Attendances.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abp_obs_project.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abp_obs_project.Grades.Grade", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abp_obs_project.Students.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abp_obs_project.Teachers.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("abp_obs_project.Attendances.Attendance", b =>
                {
                    b.HasOne("abp_obs_project.Courses.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("abp_obs_project.Students.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("abp_obs_project.Courses.Course", b =>
                {
                    b.HasOne("abp_obs_project.Teachers.Teacher", null)
                        .WithMany()
